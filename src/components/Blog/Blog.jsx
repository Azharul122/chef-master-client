    ...
    <div>
      <section className="w-full bg-[#1F2937] py-5 text-center text-white">
        <Pdf targetRef={ref} filename="code-example.pdf">
          {({ toPdf }) => (
            <button onClick={toPdf} className="bg-[#374151] px-7 py-3 rounded">
              Downlod CV
            </button>
          )}
        </Pdf>
        ...
        <section className="mb-32 text-gray-800">
          ...
          <div className="accordion accordion-flush" id="accordionFlushExample">
            ...
            <div className="accordion-item border-l-0 border-r-0 rounded-none bg-white border border-gray-200">
              ...
              >
                <div className="accordion-body py-4 px-5 text-gray-500">
                  validate any data we are receiving from props. But before
                  using it we will have to import it as always in our app:
                </div>
              </div>
            </div>
            <div className="accordion-item border-l-0 border-r-0 border-b-0 rounded-none bg-white border border-gray-200">
              ...
              >
                <div className="accordion-body py-4 px-5 text-gray-500">
                  nodejs is a programming language which is use to make back-end
                  service APIs for mobile,desktop and expressJs is a framework
                  which is use to simplify APIs.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item border-l-0 border-r-0 border-b-0 rounded-none bg-white border border-gray-200">
              ...
              >
                <div className="accordion-body py-4 px-5 text-gray-500">
                  Custom Hook is a function. .It can be reused easily, which
                  makes the code cleaner and reduces the time to write the code.
                </div>
              </div>
            </div>
          </div>
